...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-[#f6f8f7] text-[#111816]">
      <header className="sticky top-0 z-50 w-full bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(246,249,252,0.94))] px-4 py-4 backdrop-blur-xl">
