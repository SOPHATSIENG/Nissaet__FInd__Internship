...
import { Briefcase, FileText, Search, Bookmark, TrendingUp, LogOut, Clock } from 'lucide-react';
    ...
    <ProtectedRoute requiredRole="student">
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">Saved Internships</p>
          ...
          <div className="bg-white rounded-lg shadow mb-8">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-medium text-gray-900">Recommended Internships</h2>
            </div>
              ...
              <div className="p-6 hover:bg-gray-50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Tech Solutions Inc. • Remote • 3 months</p>
                    <div className="flex items-center mt-2 space-x-4">
                      <span className="text-xs text-gray-500">Posted 2 days ago</span>
                      <span className="text-xs text-gray-500">45 applications</span>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    <button className="px-3 py-1 text-sm bg-blue-600 text-white rounded hover:bg-blue-700">Apply Now</button>
                    <button className="px-3 py-1 text-sm border border-gray-300 rounded hover:bg-gray-50">Save</button>
                  </div>
                </div>
              </div>
              <div className="p-6 hover:bg-gray-50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Digital Agency • On-site • 6 months</p>
                    <div className="flex items-center mt-2 space-x-4">
                      <span className="text-xs text-gray-500">Posted 1 week ago</span>
                      <span className="text-xs text-gray-500">32 applications</span>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    <button className="px-3 py-1 text-sm bg-blue-600 text-white rounded hover:bg-blue-700">Apply Now</button>
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="divide-y divide-gray-200">
              <div className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Creative Studio • Applied 3 days ago</p>
                  </div>
                  <div className="flex items-center space-x-2">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-medium text-gray-900">Full Stack Developer Intern</h3>
                    <p className="text-sm text-gray-500">StartupXYZ • Applied 1 week ago</p>
                  </div>
                  <div className="flex items-center space-x-2">
